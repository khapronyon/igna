  ...
  return (
    <footer className="bg-granito-dark text-calce/85">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 py-16 grid grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {/* Logo + payoff — full width, centrato */}
        ...
        {/* Naviga — colonna sinistra su mobile */}
        <div className="col-span-1 md:col-span-1 text-left">
          <p className="text-xs tracking-[0.32em] uppercase text-calce/60 mb-4">Naviga</p>
        ...
        {/* Dove siamo + Contatti — colonna destra su mobile */}
        <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div>
            <p className="text-xs tracking-[0.32em] uppercase text-calce/60 mb-4">Dove siamo</p>
          ...
          <div>
            <p className="text-xs tracking-[0.32em] uppercase text-calce/60 mb-4">Contatti</p>
            <div className="flex flex-col gap-3 text-xs tracking-[0.28em] uppercase">
              <a href="#" className="hover:text-calce transition-colors">Instagram</a>
              <a href="#" className="hover:text-calce transition-colors">Facebook</a>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-calce/10">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 py-5 flex flex-col sm:flex-row gap-2 sm:justify-between items-center text-xs text-calce/50">
